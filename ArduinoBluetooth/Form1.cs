using System.IO.Ports; //SerialPort sınıfını kullanabilmek için eklenen kütüphane
...
namespace ArduinoBluetooth
{
    public partial class Form1 : Form
    {
        ...
        {
            // Bu metot, port açıklamasını almak için kullanılabilir.
            // Şu anda sadece port adını döndürüyor, ancak daha fazla bilgi eklenebilir.
            return portName;
        }
        ...
        {
            if (serialPort != null && serialPort.IsOpen) //Seri port açıksa
            {
